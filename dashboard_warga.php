...
<body class="bg-secondary-50 font-sans text-secondary-900 antialiased scroll-smooth">
    ...
    <div class="flex h-screen overflow-hidden">
        ...
        <div class="flex-1 flex flex-col min-w-0 overflow-hidden">
            <!-- Top Header -->
            <header
                class="glass sticky top-0 z-20 flex items-center justify-between px-8 py-4 border-b border-white/20">
                ...
                <div class="flex items-center space-x-4">
                    ...
                    <div
                        class="h-10 w-10 rounded-xl bg-primary-100 flex items-center justify-center text-primary-700 font-bold shadow-sm ring-2 ring-white">

    ...
    <div class="w-full max-w-md relative z-10">
        ...
        <div class="glass p-10 rounded-[2.5rem] shadow-2xl shadow-secondary-900/5 border border-white">
            ...
            <form method="POST" class="space-y-6">
                <div>
                    <label
                        class="block text-[10px] font-black text-secondary-400 uppercase tracking-[0.2em] mb-2 ml-1">Email
                        Administrator</label>
                    <div class="relative">
                ...
                <div>
                    <label
                        class="block text-[10px] font-black text-secondary-400 uppercase tracking-[0.2em] mb-2 ml-1">Password</label>
                    <div class="relative">
                ...
                <button type="submit"
                    class="w-full py-5 bg-secondary-900 text-white font-black rounded-2xl hover:bg-secondary-800 transition-all shadow-xl shadow-secondary-900/10 uppercase tracking-widest text-sm active:scale-95 flex items-center justify-center gap-3">
                    Masuk Dashboard
            ...
            <div class="mt-8 pt-8 border-t border-secondary-50 text-center">
                <p class="text-secondary-400 text-[10px] font-black uppercase tracking-widest">Akses Pengurus RT Saja
                </p>
            </div>
        </div>

...
<body
    class="bg-secondary-50 font-sans text-secondary-900 antialiased min-h-screen flex items-center justify-center p-6">
    <main class="w-full max-w-5xl">
        <div class="text-center mb-16 animate-in fade-in slide-in-from-bottom-4 duration-1000">
            <div
                class="inline-flex items-center justify-center w-20 h-20 bg-primary-600 rounded-[2rem] shadow-2xl shadow-primary-500/40 mb-8 transform hover:rotate-12 transition-transform cursor-pointer">
                <i class="fas fa-home text-white text-3xl"></i>
            </div>
            <h1 class="text-4xl md:text-5xl font-black text-secondary-900 tracking-tight mb-4">
                Sistem Manajemen <span class="text-black-600">RT 06/08</span>
            </h1>
            ...
            <div
                ...
                <div class="relative z-10 text-center">
                    ...
                    <p class="text-secondary-500 mb-10 leading-relaxed font-medium">
                        Cek info kegiatan RT terbaru, pantau transparansi kas, kirim pengaduan, dan bayar iuran tanpa
                        ribet.
                    </p>

...
<div class="bg-white p-6 rounded-[2rem] shadow-sm border border-secondary-100 mb-8">
    <form method="GET" action="dashboard_warga.php" class="grid grid-cols-1 md:grid-cols-4 gap-4 items-end">
        ...
        <div>
            <label class="block text-[10px] font-black text-secondary-400 uppercase tracking-widest mb-2 ml-1">Jenis
                Dana</label>
        ...
        <div class="md:col-span-2">
            <label
                class="block text-[10px] font-black text-secondary-400 uppercase tracking-widest mb-2 ml-1">Periode</label>
                    ...
                    <?php while ($row = $transaksi->fetch_assoc()):
                        ...
                        <tr class="group hover:bg-primary-50/20 transition-all">
                            <td class="px-8 py-5">
                                ...
                                <span
                                    class="text-[10px] font-black text-secondary-400 uppercase tracking-widest"><?= htmlspecialchars($cat) ?></span>
                            </td>
                            <td class="px-6 py-5">

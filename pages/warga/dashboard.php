...
// Kegiatan Terbaru (Otomatis Hilang Jika Sudah Selesai)
...
<div class="grid md:grid-cols-3 gap-6 mb-12">
    ...
    <div
        ...
        <div class="flex items-center gap-4">
            <div
                class="bg-green-100 text-green-600 w-14 h-14 rounded-2xl flex items-center justify-center shadow-inner">
                <i class="fas fa-arrow-down-long text-xl"></i>
            </div>
            <div>
                <span class="text-secondary-500 text-[10px] font-black uppercase tracking-widest">Pemasukan Bulan
                    Ini</span>
                <p class="text-xl font-black text-secondary-900 mt-0.5">Rp
    ...
    <div
        ...
        <div class="flex items-center gap-4">
            ...
            <div>
                <span class="text-secondary-500 text-[10px] font-black uppercase tracking-widest">Pengeluaran Bulan
                    Ini</span>
                <p class="text-xl font-black text-secondary-900 mt-0.5">Rp
    ...
    <div class="bg-primary-900 p-6 rounded-3xl shadow-xl overflow-hidden relative group">
        <div
            class="absolute -right-4 -top-4 w-24 h-24 bg-primary-500/20 rounded-full group-hover:scale-150 transition-all duration-500">
        </div>
        <div class="flex items-center gap-4 relative z-10">
            <div
                class="bg-primary-500 text-white w-14 h-14 rounded-2xl flex items-center justify-center shadow-lg shadow-primary-500/30">
        ...
        <div class="bg-white p-8 rounded-[2rem] shadow-sm border border-secondary-100">
            ...
            <div class="mt-8">
                <a href="?page=keuangan"
                    class="block w-full py-4 text-center bg-secondary-900 text-white rounded-2xl font-black text-xs uppercase tracking-widest hover:bg-secondary-800 transition-all active:scale-95">
                    Laporan Lengkap
                </a>
            </div>
        </div>

...
<form action="" method="POST" class="space-y-8">
    <div class="grid grid-cols-1 lg:grid-cols-2 gap-8 items-stretch">
        ...
        <!-- Card 2: Rekening Utama -->
        <div class="bg-white p-8 rounded-[2.5rem] shadow-sm border border-secondary-100 flex flex-col">
            <div class="flex items-center gap-4 mb-8 border-b border-secondary-50 pb-6">
                <div class="w-12 h-12 bg-secondary-900 text-white rounded-2xl flex items-center justify-center shrink-0">
            ...
            <div class="mt-6 p-4 bg-blue-50 rounded-2xl border border-blue-100 flex gap-4">
